...
#  * **Technology:** We will extend your Python knowledge from the CS230 prerequisite with more advanced table manipulation functions, extended practice with data cleaning and manipulation tasks, computational notebooks (such as Jupyter), and GitHub for version control and project publishing.
...
#  
# Details about specific topics and their order appears in [the Detailed Course Schedule appendix](course-schedule).
...
# 
# ```{admonition} Big Picture - The importance of Learning on Your Own
# ---
...
# ```
# 
# Consequently our course will contain several opportunities for you to exercise your communication skills and receive feedback from the instructor on doing so.  See the comments under the "communication" bullet [above](#what-s-in-our-course), and [the course outline in the appendix](course-schedule).  The first such opportunities appear immediately below.
# 
